...
Customer.create(name: 'hoge1', email: 'hoge1@ho.ge', password: 'hoge1')
Customer.create(name: 'hoge2', email: 'hoge2@ho.ge', password: 'hoge2')
Customer.create(name: 'hoge3', email: 'hoge3@ho.ge', password: 'hoge3')
Customer.create(name: 'hoge4', email: 'hoge4@ho.ge', password: 'hoge4')
Customer.create(name: 'hoge5', email: 'hoge5@ho.ge', password: 'hoge5')
